...
@section('page-title', 'إنشاء دور جديد')

@section('content')
<div class="max-w-lg">
    <div class="bg-white rounded-2xl shadow-sm border border-gray-100">
        <div class="px-6 py-5 border-b border-gray-100">
            <h2 class="text-base font-semibold text-gray-800">دور جديد</h2>
            <p class="text-sm text-gray-500 mt-0.5">حدد اسماً وعيّن الصلاحيات للدور الجديد.</p>
        </div>
