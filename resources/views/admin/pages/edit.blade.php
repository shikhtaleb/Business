...
<div x-data="pageForm()" class="space-y-5">
    ...
    <div class="flex items-center justify-between">
        <div class="flex items-center gap-3">
            ...
            <h2 class="text-lg font-semibold text-gray-900">تعديل الصفحة</h2>
        </div>
                    ...
                    <div class="p-5 space-y-4">
                        ...
                        <div x-show="activeTab === 'en'" x-cloak>
                            ...
                            <textarea name="body_en" rows="14"
                                      class="w-full px-3.5 py-2.5 rounded-xl border border-gray-300 text-sm focus:outline-none focus:ring-2 focus:border-transparent font-mono"
                                      style="--tw-ring-color:#FF8528"
                                      placeholder="محتوى الصفحة...">{{ old('body_en', $page->body_en) }}</textarea>
                        </div>
                ...
                <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-5 space-y-4">
                    ...
                    <div>
                        ...
                        <textarea name="meta_desc" rows="3"
                                  class="w-full px-3.5 py-2.5 rounded-xl border border-gray-300 text-sm focus:outline-none focus:ring-2 focus:border-transparent"
                                  style="--tw-ring-color:#FF8528"
                                  placeholder="وصف مختصر لمحركات البحث (١٥٠–١٦٠ حرفاً)">{{ old('meta_desc', $page->meta_desc) }}</textarea>
                    </div>
                </div>
            </div>
            ...
            <div class="space-y-5">
                ...
                <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-5 space-y-4">
                    ...
                    <div>
                        ...
                        <select name="status"
                            ...
                            <option value="published" {{ old('status', $page->status) === 'published' ? 'selected' : '' }}>منشور</option>
                        </select>
                    </div>
                ...
                <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-5 space-y-3">
                    ...
                    <select name="template"
                            class="w-full px-3.5 py-2.5 rounded-xl border border-gray-300 text-sm focus:outline-none focus:ring-2 focus:border-transparent"
                            style="--tw-ring-color:#FF8528">
                        <option value="default" {{ old('template', $page->template) === 'default' ? 'selected' : '' }}>افتراضي</option>
                        <option value="full-width" {{ old('template', $page->template) === 'full-width' ? 'selected' : '' }}>عرض كامل</option>
                        <option value="landing" {{ old('template', $page->template) === 'landing' ? 'selected' : '' }}>صفحة هبوط</option>
                    </select>
                </div>
