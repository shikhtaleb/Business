                                ...
                                @if(in_array($code, ['ar', 'en']))
                                    <div>
                                        ...
                                        <textarea name="body_{{ $code }}"
                                                  ...
                                                  class="w-full rounded-xl border border-gray-200 px-4 py-2.5 text-sm text-gray-900 focus:outline-none focus:ring-2 focus:ring-orange-400 focus:border-transparent font-mono resize-y">{{ old('body_' . $code, $post->{'body_' . $code}) }}</textarea>
