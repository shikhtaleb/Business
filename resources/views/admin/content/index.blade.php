...
<div x-data="{ show: true }" x-show="show" x-init="setTimeout(() => show = false, 4000)"
     ...
     class="mb-4 flex items-center gap-3 bg-green-50 border border-green-200 text-green-800 rounded-2xl px-5 py-3.5 text-sm font-medium shadow-sm">
...
<div x-data="{ show: true }" x-show="show" x-init="setTimeout(() => show = false, 5000)"
     class="mb-4 flex items-center gap-3 bg-red-50 border border-red-200 text-red-800 rounded-2xl px-5 py-3.5 text-sm font-medium shadow-sm">
