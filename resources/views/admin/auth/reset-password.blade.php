...
@section('content')
    <div class="mb-6 text-center">
        <h2 class="text-xl font-bold text-gray-900">Set a new password</h2>
        ...
        <div>
            ...
            <div class="relative" x-data="{ showConf: false }">
                <input
                    ...
                    class="w-full px-3.5 py-2.5 pr-10 rounded-xl border border-gray-300 text-gray-900 text-sm
                           placeholder-gray-400 focus:outline-none focus:ring-2 focus:border-transparent
                           transition-shadow @error('password_confirmation') border-red-400 bg-red-50 @enderror"
                    placeholder="••••••••"
                >
