...
<div class="max-w-2xl">
    <div class="bg-white rounded-2xl shadow-sm border border-gray-100">
        <div class="px-6 py-5 border-b border-gray-100">
            <h2 class="text-base font-semibold text-gray-800">{{ __('admin.edit_plan') }}: <span style="color:#FF8528;">{{ $plan->name_ar }}</span></h2>
        </div>
        <form method="POST" action="{{ route('admin.plans.update', $plan) }}" class="px-6 py-6 space-y-5">
            @csrf @method('PUT')
